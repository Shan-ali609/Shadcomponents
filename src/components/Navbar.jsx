...
//   return (
//     <>
//       <nav className="w-full md:px-0 lg:px-10 xl:px-14 h-auto text-[rgb(4,4,4)] flex justify-between items-center p-2 fixed z-50 bg-white dark:bg-black">
//         <button
...
//           </ul>
//           {isNavOpen && <div className="">  <Leftside /> </div> }
//         </div>
