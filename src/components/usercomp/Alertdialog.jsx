...
export default function Alertdialog({nameprop}) {
 ...
 <div>
  <Link href="#" onClick={isopen} className="mx-auto border px-3 py-1 rounded-md hover:bg-gray-100">{nameprop ? "Edit profile" :  "Show Dialog"} </Link>
  </div>
